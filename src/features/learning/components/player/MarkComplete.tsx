          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
            <div className="flex flex-1 items-center gap-6 md:gap-8">
              ...
              <div className="space-y-1 text-left">
                ...
                <h3 className="text-2xl md:text-3xl font-black text-emerald-900 dark:text-emerald-100 tracking-tight leading-tight">
                  {justCompleted ? t`Lesson Completed!` : t`Step Successfully Finished`}
                </h3>
                <p className="text-base md:text-lg font-bold text-emerald-800/60 dark:text-emerald-200/60 leading-relaxed max-w-2xl">
                  {justCompleted
            ...
            {justCompleted && (
              <div className="flex items-center gap-2 text-emerald-500 dark:text-emerald-400 bg-white/50 dark:bg-emerald-900/30 px-4 py-2 rounded-2xl border border-emerald-100/50 dark:border-emerald-800/50">
        ...
        <div className="flex flex-col items-center gap-6">
          <div className="flex flex-1 items-center gap-6 md:gap-8">
            ...
            <div className="space-y-1">
              ...
              <h3 className="text-2xl md:text-3xl font-black text-zinc-900 dark:text-zinc-100 tracking-tight leading-tight">{t`Ready to level up?`}</h3>
              <p className="text-base md:text-lg font-bold text-zinc-500 dark:text-zinc-400 leading-relaxed max-w-2xl">
          ...
          <Button
            ...
            disabled={isMarking}
            className="self-center rounded-2xl bg-zinc-900 dark:bg-zinc-100 hover:bg-zinc-800 dark:hover:bg-zinc-200 text-white dark:text-zinc-900 font-black h-14 px-10 text-base shadow-2xl shadow-zinc-200 dark:shadow-none transition-all hover:scale-[1.05] active:scale-[0.95] w-full lg:w-auto"
          >
            {isMarking ? (
              <>

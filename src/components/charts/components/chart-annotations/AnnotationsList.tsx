  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>{chart.annotations.length} annotations</CardDescription>
      </CardHeader>
      <CardContent>
        {chart.annotations.length === 0 ? (
          <div className="text-center py-4">
            <p className="text-sm text-muted-foreground mb-3">No annotations yet.</p>
            <Button size="sm" onClick={onAddAnnotation}>Add Annotation</Button>
          </div>
        ) : (

...
export function PageCard({
  ...
  return (
    <Link
      to={to}
      className={cn(
        "group relative block h-full w-full overflow-hidden rounded-2xl bg-white shadow-lg transition-transform duration-300 ease-in-out hover:scale-105 dark:bg-slate-800/80",
        className,
      )}
    >

...
**Codul:** 90
**Denumirea:** Rezerve, excedent/deficit
...
1. **Căutare și Validare:**
   ...
   - Determină natura indicatorului: Capitol final - rezultat bugetar
   - Include Rezerve (91.01), Excedent (92.01), Deficit (93.01)

2. **Sinteză Tehnică:**
   - Explică ce reprezintă rezultatul bugetar
   - Formulează logica de calcul pentru baze de date
   - Menționează diferența între excedent și deficit
...
## Capitol 90 - Rezerve, excedent/deficit

### Definiție și scop

[Descriere clară a ce reprezintă acest capitol din clasificația economică.]
[Explică că reflectă rezultatul execuției bugetare.]
...
[Explică mecanismul: Cum se calculează? Ce înseamnă excedent vs deficit?]

1. [Componentă - Rezerve (91.01)]
2. [Componentă - Excedent (92.01) - Venituri > Cheltuieli]
3. [Componentă - Deficit (93.01) - Cheltuieli > Venituri]

### Utilizare în calcul și impact bugetar

**Semn și Logică:**
[Explică: Excedent = pozitiv, Deficit = negativ]

**Formula simplificată:**

```
Rezultat bugetar = Venituri totale - Cheltuieli totale
Dacă > 0: Excedent (92.01)
Dacă < 0: Deficit (93.01)
```
...
|-----------|-----------|------------|
| Buget de Stat | Deficit frecvent | [Acoperit prin împrumuturi] |
| Bugete Locale | Obligatoriu echilibru | [Nu pot avea deficit] |

### Aspecte importante

**1. [Aspect Cheie 1]:** [Bugetele locale trebuie echilibrate]
**2. [Aspect Cheie 2]:** [Deficitul bugetului de stat și acoperirea sa]
**3. Magnitudine:** [Deficit buget stat - % din PIB]
...
- [Instrucțiune clară: interpretarea excedentului/deficitului]

**Pentru analiză la nivel de buget general consolidat:**
- [Instrucțiune clară: deficitul consolidat și țintele fiscale]

### Întrebări frecvente (FAQ)

**Q1: Care este diferența dintre excedent și deficit?**
A: [Răspuns concis]

**Q2: De ce bugetele locale nu pot avea deficit?**
A: [Răspuns concis - Legea 273/2006]

**Q3: Cum se acoperă deficitul bugetului de stat?**
A: [Răspuns concis - împrumuturi]
...
4. [**Tratatul fiscal european**](https://eur-lex.europa.eu)

### Notă importantă

[Context final despre rezultatul bugetar, țintele de deficit conform regulilor UE și importanța sustenabilității fiscale.]

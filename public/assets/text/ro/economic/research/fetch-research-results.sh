...
# =============================================================================
# Processes research files, extracts Claude.ai URL from ## Research URL section,
# runs web-flow research-extraction, and saves output to economic folder.
#
...
process_research_file() {
    ...
    # Extract code from filename (e.g., research-ec-10.01.md -> 10.01)
    local code=$(basename "$filename" .md | sed 's/^research-ec-//')
...
if [[ -n "$SINGLE_FILE" ]]; then
    ...
    # Process all research-ec-*.md files (exclude README)
    files_to_process=()
    for f in "$RESEARCH_DIR"/research-ec-*.md; do
...
echo ""
log "=========================================="
log "Fetch Research Results Complete"
log "=========================================="

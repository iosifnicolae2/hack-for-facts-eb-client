...
1. **Căutare și Validare:**
   ...
   - Include achiziții de participații, acțiuni, obligațiuni

2. **Sinteză Tehnică:**
   - Explică ce tipuri de active financiare există
   - Formulează logica de calcul pentru baze de date
   - Menționează diferența față de active nefinanciare
...
## Capitol 72 - Active financiare

### Definiție și scop

[Descriere clară a ce reprezintă acest capitol din clasificația economică.]
[Explică ce sunt activele financiare: participații, acțiuni, obligațiuni.]
...
[Explică mecanismul: Ce tipuri de investiții financiare? În ce entități?]

1. [Componentă - Active financiare (72.01)]
...
**Semn și Logică:**
[Explică că este cheltuială de capital (+), dar poate genera venituri ulterioare (dividende)]

**Formula simplificată:**

```
Active financiare (72) = Active financiare (72.01)
```
...
|-----------|-----------|------------|
| Buget de Stat | + | [Participații la întreprinderi de stat] |
| Bugete Locale | + | [Participații locale] |

### Aspecte importante

**1. [Aspect Cheie 1]:** [Diferența față de active nefinanciare]
**2. [Aspect Cheie 2]:** [Participații la întreprinderi de stat]
...
- [Instrucțiune clară: tratamentul participațiilor în entități publice]

### Întrebări frecvente (FAQ)

**Q1: Ce este o participație la capitalul social?**
A: [Răspuns concis]

**Q2: Statul investește în companii private?**
A: [Răspuns concis]

**Q3: Cum se recuperează investiția în active financiare?**
A: [Răspuns concis - dividende, vânzare]
...
[Context final despre importanța activelor financiare și participațiilor statului.]
